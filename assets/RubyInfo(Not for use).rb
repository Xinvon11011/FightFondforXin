...
It will result and print the floorplan Images as the Old Arcetict Layout white and Black with Vector drawings. This will turn out to be a PNG Image instead of PNG. which is Downloadable still. Only using White PNG background and Black lines for Strokes and Pictured

Text Format (JS and Python)
While on PNG Creation it Will add text based on which room is which. This does add the non-Living spaces but It will not be added the Measurents Though. Also when PNG Makes the Floorplan It Wont be able to add the Objects except Arcitect objects like Stairs windows doors and Attached Walls
...
PNG the Vector it Goes (JS and Python)
The Floorplan Images will turn out to be PNG Images instead of PNG for the Canvas of Results. If it was a Error or a Fail thi Shows the Text (Generation Error) Colored red and with Pink Box Background. Disabling the Image Options.
...
For each Update report got from Student 1 2 and 3 This AI Makes the PNG Floorplans up to 8 Different floorplans can be created And will make the Floorplans that is extremley Similar based by the House images and Maybe if Description is Added also which can Help and be useful.

Student 5 (TensorFlow)
This AI Adds the Text to the Floorplan PNG Additinoaly With the Help of Student 4 helping this AI to Put where the Text should be. Although this will Label Non-Living Spaces (Garage Floor openings Voids and basement.) But might be Colored Blue or Red because those arent Really Living Spaces while the other Living Spaces Text are Colored black.

Student 6 (TensorFlow)
this AI Will either get the 8 PNG Images floorplan and Display it on HTML Showcase or it Will just show the Error that it wasnt Able to do it.
...
Student 6 (ML5)
If floorplans were sucsuss created from PNG Making This tells the Script.js to show those and be ready to download. If errored Countered this Writes a Text from the Canvas Result Error Generating. Marking this as Finished and Showing the Reset button.
